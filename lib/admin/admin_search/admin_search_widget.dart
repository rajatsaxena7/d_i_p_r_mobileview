...
import 'admin_search_model.dart';
export 'admin_search_model.dart';
...
class _AdminSearchWidgetState extends State<AdminSearchWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminSearchModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<AdvertisementRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AdvertisementRecord> adminSearchAdvertisementRecordList =
            snapshot.data!;
                                          ...
                                          onFieldSubmitted: (_) async {
                                            safeSetState(() {
                                              _model.simpleSearchResults =
                                                  TextSearch(
                                                adminSearchAdvertisementRecordList
                                                    .where((e) =>
                                                    ...
                                                    () {
                                                      if ((searchresultItem
                                                          ...
                                                          (searchresultItem
                                                                  .isCaseWorker ==
                                                              true)) {
                                                        return 'Accepted by Case Worker';
                                                      } else if (searchresultItem
                                                              .statusDeputy ==
                                                          1) {
                                                        return 'Viewed with out action By Deputy Director';
                                                      } else if (searchresultItem
                                                              .statusDeputy ==
                                                          2) {
                                                        return 'Approved by Deputy Director';
                                                      } else if (searchresultItem
                                                              .statusDeputy ==
                                                          3) {
                                                        return 'Rejected by Deputy Director';
                                                      } else if (searchresultItem
                                                              .statusCaseworker ==
                                                          0) {
                                                        return 'Not processed by Case Worker';
                                                      } else if (searchresultItem
                                                              .statusCaseworker ==
                                                          1) {
                                                        return 'Release Order generated by Case Worker';
                                                      } else if (searchresultItem
                                                              .statusCaseworker ==
                                                          2) {
