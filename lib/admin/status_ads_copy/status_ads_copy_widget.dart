...
import 'status_ads_copy_model.dart';
export 'status_ads_copy_model.dart';

class StatusAdsCopyWidget extends StatefulWidget {
  const StatusAdsCopyWidget({super.key});

  @override
  State<StatusAdsCopyWidget> createState() => _StatusAdsCopyWidgetState();
}

class _StatusAdsCopyWidgetState extends State<StatusAdsCopyWidget>
    with TickerProviderStateMixin {
  late StatusAdsCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StatusAdsCopyModel());
          ...
          children: [
            Align(
              ...
              child: FlutterFlowButtonTabBar(
                ...
                unselectedBorderColor: FlutterFlowTheme.of(context).primary,
                borderWidth: 4.0,
                borderRadius: 8.0,
                elevation: 0.0,
                buttonMargin:
                            ...
                            child: Padding(
                              ...
                              child: StreamBuilder<AdvertisementRecord>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  final containerAdvertisementRecord =
                                      snapshot.data!;
                                  return Container(
                                    decoration: const BoxDecoration(),
                                    child: Visibility(
                                      visible:
                                          _model.adrefresult?.reference != null,
                                      child: Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            40.0, 10.0, 40.0, 20.0),
                                        child: Column(
                                                            ...
                                                            children: [
                                                              Container(
                                                                ...
                                                                decoration:
                                                                    BoxDecoration(
                                                                  color: () {
                                                                    if ((containerAdvertisementRecord.statusDeputy ==
                                                                            0) &&
                                                                        (containerAdvertisementRecord.isCaseWorker ==
                                                                            true)) {
