...
import 'add_attachments_model.dart';
export 'add_attachments_model.dart';

class AddAttachmentsWidget extends StatefulWidget {
  ...
  @override
  State<AddAttachmentsWidget> createState() => _AddAttachmentsWidgetState();
}

class _AddAttachmentsWidgetState extends State<AddAttachmentsWidget> {
  late AddAttachmentsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddAttachmentsModel());
  }
                    ...
                    builder: (context) => FFButtonWidget(
                      onPressed: () async {
                        ...
                        await widget.adveref!.update({
                          ...
                          ...mapToFirestore(
                            {
                              'ListOfUploads': FieldValue.arrayUnion(
