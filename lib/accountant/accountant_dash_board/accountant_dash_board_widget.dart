...
import 'accountant_dash_board_model.dart';
export 'accountant_dash_board_model.dart';

class AccountantDashBoardWidget extends StatefulWidget {
  const AccountantDashBoardWidget({super.key});

  @override
  State<AccountantDashBoardWidget> createState() =>
      _AccountantDashBoardWidgetState();
}

class _AccountantDashBoardWidgetState extends State<AccountantDashBoardWidget>
    with TickerProviderStateMixin {
  late AccountantDashBoardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AccountantDashBoardModel());
    ...
    return StreamBuilder<List<AdvertisementRecord>>(
      stream: queryAdvertisementRecord(
        queryBuilder: (advertisementRecord) => advertisementRecord
            ...
            .orderBy('RODATE', descending: true),
      ),
      builder: (context, snapshot) {
        ...
        List<AdvertisementRecord> accountantDashBoardAdvertisementRecordList =
            snapshot.data!;
