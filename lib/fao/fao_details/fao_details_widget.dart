...
import 'fao_details_model.dart';
export 'fao_details_model.dart';

class FaoDetailsWidget extends StatefulWidget {
  const FaoDetailsWidget({
    super.key,
    this.listofapproved,
    this.assitantFb,
    required this.ddFb,
  ...
  @override
  State<FaoDetailsWidget> createState() => _FaoDetailsWidgetState();
}

class _FaoDetailsWidgetState extends State<FaoDetailsWidget> {
  late FaoDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FaoDetailsModel());
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<ApprovedAddRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final faoDetailsApprovedAddRecord = snapshot.data!;
                      ...
                      Container(
                        ...
                        child: GridView(
                          ...
                          children: [
                            if (widget.assitantFb != null &&
                              ...
                              Container(
                                ...
                                child: Align(
                                  ...
                                  child: Text(
                                    '${() {
                                      if (faoDetailsApprovedAddRecord
                                              .division ==
                                          1) {
                                        return 'UDC 2';
                                      } else if (faoDetailsApprovedAddRecord
                                              .division ==
                                          2) {
                                        return 'LDC';
                                      } else {
                            ...
                            if (widget.secrefb != null && widget.secrefb != '')
                              Container(
                                width: MediaQuery.sizeOf(context).width * 0.16,
                                height: 100.0,
                                decoration: BoxDecoration(
                      ...
                      Material(
                        ...
                        child: Container(
                          ...
                          child: Builder(
                            builder: (context) {
                              final invoicee =
                                  faoDetailsApprovedAddRecord.adddata.toList();
                              return ListView.builder(
                                padding: EdgeInsets.zero,
                                scrollDirection: Axis.vertical,
                                itemCount: invoicee.length,
                                itemBuilder: (context, invoiceeIndex) {
                                  final invoiceeItem = invoicee[invoiceeIndex];
                                  return Padding(
