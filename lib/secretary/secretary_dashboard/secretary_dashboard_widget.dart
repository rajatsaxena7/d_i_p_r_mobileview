...
import 'secretary_dashboard_model.dart';
export 'secretary_dashboard_model.dart';

class SecretaryDashboardWidget extends StatefulWidget {
  const SecretaryDashboardWidget({super.key});

  @override
  State<SecretaryDashboardWidget> createState() =>
      _SecretaryDashboardWidgetState();
}

class _SecretaryDashboardWidgetState extends State<SecretaryDashboardWidget>
    with TickerProviderStateMixin {
  late SecretaryDashboardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SecretaryDashboardModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<InvoiceRequestRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<InvoiceRequestRecord> secretaryDashboardInvoiceRequestRecordList =
            snapshot.data!;
                  ...
                  child: StreamBuilder<List<NotificationAdminRecord>>(
                    stream: queryNotificationAdminRecord(
                      queryBuilder: (notificationAdminRecord) =>
                          notificationAdminRecord.orderBy('Created',
                              descending: true),
                    ),
                    builder: (context, snapshot) {
                      // Customize what your widget looks like when it's loading.
