...
import 'director_dash_board_model.dart';
export 'director_dash_board_model.dart';

class DirectorDashBoardWidget extends StatefulWidget {
  const DirectorDashBoardWidget({super.key});

  @override
  State<DirectorDashBoardWidget> createState() =>
      _DirectorDashBoardWidgetState();
}

class _DirectorDashBoardWidgetState extends State<DirectorDashBoardWidget>
    with TickerProviderStateMixin {
  late DirectorDashBoardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DirectorDashBoardModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<AdvertisementRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AdvertisementRecord> directorDashBoardAdvertisementRecordList =
            snapshot.data!;
